...
def simulate_position():
    ...
    try:
        ...
        # Проверяем зоны
        zones = check_player_zones(user.id, lat, lng)
...
def teleport_to_pickup():
    ...
    try:
        ...
        # Проверяем зоны
        zones = check_player_zones(user.id, pickup_lat, pickup_lng)
...
def teleport_to_dropoff():
    ...
    try:
        ...
        # Проверяем зоны
        zones = check_player_zones(user.id, dropoff_lat, dropoff_lng)
