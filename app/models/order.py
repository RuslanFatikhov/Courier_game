...
class Order(db.Model):
    ...
    def __init__(self, **kwargs):
        ...
        if self.pickup_lat and self.pickup_lng and self.dropoff_lat and self.dropoff_lng:
            ...
            self.expires_at = now_utc() + timedelta(seconds=config.get('pickup_timeout', 3600))
    ...
    def to_dict(self):
        ...
        return {
            ...
            'pickup_time': isoformat_utc(self.pickup_time),
            'delivery_time': isoformat_utc(self.delivery_time),
